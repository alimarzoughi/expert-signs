  ...
  return (
    <footer className="text-secondary-foreground">
      <div className="w-full px-4 py-12">
        ...
        {/* Full-width, evenly spaced grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-40 md:pl-10 max-w-7xl mx-auto w-full">
          ...
          <div className="text-left">
            ...
            <p className="leading-relaxed">
              ...
              that not only communicates, but captivates.
            </p>
          </div>
